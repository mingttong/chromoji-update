                    ...
                    if (src) {
                        ...
                        for (attrname in attrib) {
                            if (
                                ...
                                !span.hasAttribute(attrname)
                            ) {
                                span.setAttribute(attrname, attrib[attrname]);
                            }
                        }
                        span.className = options.className;
                        span.alt = alt;
                        span.setAttribute('style', `background: url('${src}');background-size:100%`);
                        modified = true;
                        fragment.appendChild(span);
                    }
                }
                if (!span) fragment.appendChild(createText(alt));
                span = null;
            }
        ...
        return replace(str, function (match, icon, variant) {
            ...
            if (variant !== '\uFE0E') {
                ...
                if (src) {
                    ...
                    //     '"'
                    //   );
                    ret = `<span style="background:url('${src}');background-size:100%;width:14px;height:14px;display:inline-block;"></span>`;
                    // console.log(ret);
                    // attrib = options.attributes(icon, variant);
                    // for (attrname in attrib) {
                    //     if (
